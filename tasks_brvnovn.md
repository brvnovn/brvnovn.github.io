...
31. [x] atualizar o componente interativo `.analise` do artigo "Evoluir é errar" para o novo formato de imagens (branch `analise-formato-vertical`): caixa se adapta só na vertical (aspect-ratio 1230/2400, sem distorcer), imagens de `refs/artigo 01/paragrafo_*.png` associadas aos parágrafos certos (algumas reaproveitadas em mais de um parágrafo), destaques em ciano removidos do CSS/JS por já estarem embutidos nas imagens, coluna de texto mantida em 406px.